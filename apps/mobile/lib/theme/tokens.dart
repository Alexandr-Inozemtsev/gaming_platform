...
class AppTokens {
  ...
  static const Color releaseOk = Color(0xFF4EE59A);
  static const Color releaseFail = Color(0xFFFF5C7A);
  static const Color modCaseOpen = Color(0xFFFFD166);
  static const Color modCaseClosed = Color(0xFF4EE59A);
